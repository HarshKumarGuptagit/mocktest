...
const questionsData = {
  Economics: [
    ...
    {
      question:
        "Which economic concept refers to the total value of goods and services produced in a country?",
      options: [
        "A. Inflation",
    ...
    },
    {
      ...
      options: [
        ...
        "C. Demand and prices are unrelated",
    ...
    },
    {
      ...
      options: [
        ...
        "B. Market with many sellers",
        "C. Market with a few sellers",
        "D. Market with identical products",
      ],
      correctAnswer: "C",
    },
    {
      ...
      options: [
        ...
        "B. Cost of the next best alternative",
    ...
    {
      question:
        "What is a fiscal policy tool used to stimulate economic activity?",
      options: [
        "A. Monetary policy",
  ...
  History: [
    ...
    {
      question:
        "Which war was fought between the North and the South during the 1860s in the United States?",
      options: [
        "A. World War I",
        "B. Civil War",
        "C. Revolutionary War",
  ...
  English: [
    ...
    {
      question:
        "Which literary period is known for its focus on reason, logic, and order?",
      options: [
        "A. Romanticism",
        "B. Gothic",
        "C. Renaissance",
    ...
    {
      question:
        'In Shakespeare\'s "Hamlet," what is the famous soliloquy that begins with "To be or not to be"?',
      options: [
        "A. The Dagger Speech",
        "B. The Seven Ages of Man",
        "C. The Sermon on the Mount",
        "D. The To Be or Not To Be Speech",
      ],
      correctAnswer: "D",
    },
    {
    ...
    {
      question:
        "Which Shakespearean play features the characters Macbeth and Lady Macbeth?",
      options: [
        "A. Othello",
        "B. King Lear",
        "C. Macbeth",
  ...
  "Political Science": [
    ...
    {
      question:
        'Who wrote the book "The Prince," which explores political power and leadership?',
      options: [
        "A. Thomas Hobbes",
        "B. John Locke",
    ...
    {
      question:
        "In the United States, what is the term length for a member of the House of Representatives?",
...
function submitExam() {
  ...
  window.location.href = "performance.html?scores=" + scoresParameter;
}
